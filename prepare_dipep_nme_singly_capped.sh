...
python generate_pdbs.py --folder data/dipep_nme_singly_capped -s $sequences_str --nme_cap
...
python smiles_string.py data/dipep_nme_singly_capped
...
python generate_states.py data/dipep_nme_singly_capped -n 50 -t 300