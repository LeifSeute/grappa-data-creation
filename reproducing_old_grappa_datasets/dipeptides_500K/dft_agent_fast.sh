...
THIS_DIR=/hits/fast/mbm/seutelf/software/grappa_data_creation/dipeptides_500K
DS=data/dipeptides_500K

MEM=90                                   # Memory per python script
CORES=12                                 # Cores per python script
NUM_AGENTS=1                             # Number of parallel agents
